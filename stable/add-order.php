...
if (($dateStartDay != '')&&($dateStartMonth != '')&&($dateStartYear != '')&&($dateEndMonth != '')&&($dateEndYear != '')){
...
$dateInterval = $intervalDate->format("%a");
...
VALUES("'.$User_ID.'", "166", "246", "'.$resultSum.'", "'.$dateStart.'", "'.$theEndDateForShow.'",  "'.$Object.'",  "'.$Price.'", "'.$Parrent.'" , "'.$dateInterval.'")';
if(mysql_query($sql))
