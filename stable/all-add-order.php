...
elseif  (($dateEndMonth_Arr == '')&&($dateEndYear_Arr == '')){
...
//VALUES("'.$row["User_ID"].'", "166", "246", "'.$resultSum_Arr.'", "'.$dateStart_Arr.'", "'.$theEndDateForShow_Arr.'",  "'.$row["Article"].'",  "'.$row["Price"].'", "'.$row["Parrent"].'" , "'.$dateInterval_Arr.'")';
if(mysql_query($sql))
